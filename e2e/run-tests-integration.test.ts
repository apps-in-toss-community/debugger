 ...
 *
 * Vendored from devtools' `e2e/run-tests-integration.test.ts`
 * (devtools@61aa2d0228df27c2c0ab2405726dd5301067981e, "SPLIT FREEZE"
 * devtools#813). Only the two `../src/...` import paths below were adjusted
 * (`../packages/debugger/src/...`) to reflect this repo's different
 * top-level layout (`e2e/` is a sibling of `packages/`, not of `src/`); no
 * other content changed. This repo has no root-level e2e tooling
 * (`@playwright/test` devDependency, `playwright.config.ts`) wired up yet —
 * that is follow-up work (see this repo's issue #3 / #4).
 */
...
import { LocalCdpConnection } from '../packages/debugger/src/mcp/local-connection.js';
import { runWithConnection } from '../packages/debugger/src/test-runner/cli.js';
